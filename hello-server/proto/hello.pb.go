...
type HelloRequest struct {
	...
	// int age=2
	RequestAge int32 `protobuf:"varint,2,opt,name=requestAge,proto3" json:"requestAge,omitempty"`
}
...
func (x *HelloRequest) GetRequestAge() int32 {
	if x != nil {
		return x.RequestAge
	}
	return 0
...
func (x *HelloResponse) GetRequestName() string {
	if x != nil {
		return x.RequestName
	}
	return ""
...
var file_hello_proto_rawDesc = []byte{
	...
	0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x67, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x67, 0x65, 0x22,
	...
	0x6d, 0x65, 0x32, 0x37, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x2b,
